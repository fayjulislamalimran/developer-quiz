          ...
          <div className="max-w-xl sm:mx-auto lg:max-w-2xl">
            <div className="flex flex-col mb-10 sm:text-center sm:mb-0">
              ...
              <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                ...
                <p className="text-base text-indigo-100 md:text-lg">This is a developer quiz made by freeCodeCamp</p>
                <p className="text-base text-indigo-100 md:text-lg"></p>
              </div>
              <div>
                <Link to="/" className=" bg-orange-300 inline-flex items-center justify-center h-12 px-6 font-semibold tracking-wide text-indigo-100 transition duration-200 rounded shadow-md hover:text-deep-purple-900  focus:shadow-outline focus:outline-none">
                  Get started
                </Link>
              </div>
            </div>
